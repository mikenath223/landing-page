...
const Result = ({ treatment }) => {
  ...
  return (
    <>
      <h3 className={treatment.value === 'dont-treat' ? 'show-elem result-text' : 'hide-elem'} data-testid="not-treated">
      ...
      <h3 className={treatment.value === 'treat' ? 'show-elem result-text' : 'hide-elem'} data-testid="treated">
